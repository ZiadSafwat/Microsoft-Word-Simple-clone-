...
ThemeData myTheme(Brightness brightness) {
  ...
  return ThemeData(
    ...
    primaryColor: Color(0xFF0D47A1), // Darker Blue
    scaffoldBackgroundColor: isDarkMode ? Color(0xFF0A1D37) : Color(0xFFDDEAF5),

    appBarTheme: AppBarTheme(
      backgroundColor: isDarkMode ? Color(0xFF1A237E) : Color(0xFF81D4FA),
      elevation: 1,
